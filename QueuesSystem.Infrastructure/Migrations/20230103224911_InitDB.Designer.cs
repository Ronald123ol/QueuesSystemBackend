...
namespace QueuesSystem.Infrastructure.Migrations
{
    ...
    [Migration("20230103224911_InitDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QueuesSystem.Domain.Entities.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QueuesSystem.Domain.Entities.PersonQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QueuesSystem.Domain.Entities.Queue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QueuesSystem.Domain.Entities.PersonQueue", b =>
                {
                    b.HasOne("QueuesSystem.Domain.Entities.Person", "Person")
                        .WithMany()
                    ...
                    b.HasOne("QueuesSystem.Domain.Entities.Queue", "Queue")
                        .WithMany()
